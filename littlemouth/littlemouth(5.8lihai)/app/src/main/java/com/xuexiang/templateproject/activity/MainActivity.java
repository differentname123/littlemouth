...
import com.xuexiang.templateproject.fragment.profile.headchoose;
import com.xuexiang.templateproject.fragment.share.Page1_AddActivity;
import com.xuexiang.templateproject.fragment.share.ShareFragment;
...
public class MainActivity extends BaseActivity implements View.OnClickListener, ViewPager.OnPageChangeListener, BottomNavigationView.OnNavigationItemSelectedListener, ClickUtils.OnClick2ExitListener, Toolbar.OnMenuItemClickListener {
    ...
    private void initHeader() throws IOException {
        ...
        ivAvatar.setImageResource(R.drawable.d);
        tvAvatar.setText("游客666");
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_privacy:
                ...
                Intent intent=new Intent(this, Page1_AddActivity.class);
                startActivity(intent);
                break;
            default:
                break;
