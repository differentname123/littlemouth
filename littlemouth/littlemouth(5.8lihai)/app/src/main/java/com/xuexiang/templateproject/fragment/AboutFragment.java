...
public class AboutFragment extends BaseFragment {
    ...
    protected void initViews() {
        ...
        XUIGroupListView.newSection(getContext())
                .addItemView(mAboutGroupListView.createItemView(getResources().getString(R.string.about_item_homepage)), v -> AgentWebActivity.goWeb(getContext(), "https://github.com/differentname123/littlemouth"))
                .addItemView(mAboutGroupListView.createItemView(getResources().getString(R.string.about_item_author_github)), v -> AgentWebActivity.goWeb(getContext(), "https://github.com/differentname123"))
